...
resource "google_cloud_run_v2_service" "api" {
  ...
  template {
    ...
    containers {
      ...
      # Inject Stripe credentials from Secret Manager
      env {
  ...
  depends_on = [
    ...
    google_secret_manager_secret_version.stripe_price_id,
...
resource "google_secret_manager_secret" "stripe_secret_key" {
  secret_id = "werewolves-stripe-secret-key"
...
resource "google_secret_manager_secret" "stripe_webhook_secret" {
  secret_id = "werewolves-stripe-webhook-secret"
...
resource "google_secret_manager_secret" "stripe_price_id" {
  secret_id = "werewolves-stripe-price-id"
